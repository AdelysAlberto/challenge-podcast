...
const configEnv: IConfig = {
  ...
  podcast_details: (id) => `${process.env.REACT_APP_PROXY}charset=utf-8&url=${process.env.REACT_APP_PODCAST_DETAIL_URL}id=${id}`,
  podcast_feed: (url) => `${process.env.REACT_APP_PROXY}charset=utf-8&url=${url}`,
